...
TEST(LoggerTest, InfoWritesInfoLineToFile)
{
  ...
  const std::string expectedPath = "/RasPike-ART/sdk/workspace/etrobocon2026/tests/datafiles/logfiles/logfile.txt";
...
TEST(LoggerTest, OutputsAllLogLevelsToFile)
{
  ...
  const std::string expectedPath = "/RasPike-ART/sdk/workspace/etrobocon2026/tests/datafiles/logfiles/logfile2.txt";
