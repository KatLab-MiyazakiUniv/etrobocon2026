...
class SystemInfo {
 public:
  // ETラリーMapの定義
  static constexpr double FIRST_X_GRID_SIZE = 220.0;  // X方向の最初の区間(mm)
  static constexpr double FIRST_Y_GRID_SIZE = 230.5;  // Y方向の最初の区間(mm)
  static constexpr double GRID_SIZE_X = 122.5;        // X方向の通常の区間(mm)
  static constexpr double GRID_SIZE_Y = 122.5;        // Y方向の通常区間(mm)
