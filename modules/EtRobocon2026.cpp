...
void EtRobocon2026::start()
{
   ...
   * 90度回頭などに使用。
   */
  const Pid::PidGain rotationPid = { 1.3, 1.0, 0.02 };
  ...
  RouteFollower routeFollower(robot, etRallyMap, mapData, TARGET_SPEED, rotationPid,
                              squareRotationPid, rightPid, leftPid, straightAnglePid);
