...
namespace {
   ...
   * 少しずれがある場合の許容値。
   *
   * 例えば検出予定位置を7.5mm通過していても、
   * 10mm以内ならQR①をスキップせずその場で検出する。
   */
                                   ...
                                   bool rotatedAtSegmentStart)
{
  ...
  //
  // QR②補正成功時は、
  // traveledDistance基準ではなくQR②位置基準なので、
  // straightWithinSegment()ではなくstraight()を使用する。
  // =========================================================
