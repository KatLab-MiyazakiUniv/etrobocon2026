...
{
  Logger::info(
      "RouteFollower square correction gate test start");
  ...
  if(!robot
    ...
    Logger::error(
        "EtRobocon2026:カメラサーバーへの接続に失敗しました");
  ...
  Logger::info(
      "RouteFollower square correction gate test finished");
}