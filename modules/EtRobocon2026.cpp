...
{
  Logger::info(
      "RouteFollower QR gate test start");
   ...
   * @brief QR追従走行速度
   */
  constexpr double QR_TRACKING_SPEED =
      200.0;

  /**
   * @brief QRコードを合わせる画像上のX座標
   *
   * 1920px幅なので中央は960。
   */
  constexpr int QR_TARGET_X =
      960;
